...
The entire weblog is created by the amazing [`Quarto`](https://quarto.org/) package which supports Julia, Python, and R languages. A great contribution from the [`Posit`](https://posit.co/) team. Thanks a lot!
